...
DL_types = ['ResResnet-L1',
            'ResResnet-PL4',]
            # 'RED-PL4',
            # 'UNet-L1',
            # 'UNet-PL4',]
            
DL_names = ['ResNet-L1', 'ResNet-PL4']#, 'RED-PL4', 'UNet-L1', 'UNet-PL4']

# DL_names = ['ResNet', 'RED', 'UNet']

# DL_types = ['ResResnet-Noise2Sim',
#             'RED-Noise2Sim',
#             'UNet-Noise2Sim',]

# DL_types = ['ResResnet-VSTasLayer-MNSE_rnw0.01357164',
#             # 'RED-VSTasLayer-MNSE_rnw0.01357164',
#             # 'UNet-VSTasLayer-MNSE_rnw0.01357164',]
#             'ResResnet-VSTasLayer-MNSE_rnw0.33800761',
#             # 'RED-VSTasLayer-MNSE_rnw0.33800761',
#             # 'UNet-VSTasLayer-MNSE_rnw0.33800761',]
#             'ResResnet-VSTasLayer-MNSE_rnw0.94957105',]
#             #'RED-VSTasLayer-MNSE_rnw0.94957105',
#             #'UNet-VSTasLayer-MNSE_rnw0.94957105',]

# DL_names = ['ResNet-$VST_{0.01}$',# 'RED-$VST_{0.01}$', 'UNet-$VST_{0.01}$',]
#               'ResNet-$VST_{0.33}$',# 'RED-$VST_{0.33}$', 'UNet-$VST_{0.33}$',]
#             'ResNet-$VST_{0.95}$']#, 'RED-$VST_{0.95}$', 'UNet-$VST_{0.95}$',]
