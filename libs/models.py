...
class UNet2(nn.Module):
    def __init__(self, tau, sigma_e, red_factor, maxGAT, minGAT, num_filters=64, n_channels=1, n_classes=1, bilinear=False, residual=False, activation_type="relu", use_bn=True):
...
class RED(nn.Module):
    def __init__(self, tau, sigma_e, red_factor, maxGAT, minGAT, num_filters=64, in_channels=1, out_channels=96, num_layers=5, kernel_size=5, padding=0):
