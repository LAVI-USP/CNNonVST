...
reduc_factors = [50]
rnw_weights = ['0.01357164','0.33800761', '0.94957105'] #['']#
...
for reduc_factor in reduc_factors:
    for rnw_weight in rnw_weights:
        ...
        python_command = "{} main_training_MNSE.py \
                  --rf {} \
                  --rfton {} \
                  --rnw {}".format(python_path, reduc_factor, 100, rnw_weight)
        ...
        python_command = "{} main_testing.py \
                  --rf {} \
                  --rfton {} \
                  --model {}{}".format(python_path, reduc_factor, 100, model_type, rnw_weight)
